...
export default function Additives({ email }: any) {
    const { additivesLoading, setAdditivesLoading, additivesData, setAdditivesData } = useStateContext();

    if (!additivesLoading) {
        const querySnapshot = async() => {
            try {
                const notesData: any = await getDocs(collection(db, "winemakers", email, "additives"));
        ...
        <>
            {additivesData === undefined ? (
                ...
                <div className={styles.notes}>
                    ...
                    <details open>
                        <summary><span>Čiření</span></summary>
                        <hr />
                    ...
                    <details>
                        <summary><span>Enzymy</span></summary>
                        <hr />
                    ...
                    <details>
                        <summary><span>Kvasinky</span></summary>
                        <hr />
                    ...
                    <details>
                        <summary><span>Výživa</span></summary>
                        <hr />
                    ...
                    <details>
                        <summary><span>Taniny</span></summary>
                        <hr />
                    ...
                    <details>
                        <summary><span>Ostatní</span></summary>
                        <hr />
