    ...
    return (
        <div className={styles.addNoteShow}>
            <div className={styles.inputBox}>
                <label><strong>Přidat víno</strong></label>
                <div className={styles.inputs}>
                    <label>Odrůda
                        <input type="text" placeholder='Odrůda' onChange={nameValue} required />
                    </label>
                    <label>Přívlastek
                        <input type="text" placeholder='Přívlastek' onChange={subValue} required />
                    </label>
                    <label>Ročník
                        <input type="text" placeholder='Ročník' onChange={yearValue} required />
                    </label>
                    <label>Trať
                        <input type="text" placeholder='Trať' onChange={placeValue} required />
                    </label>
                    <label>Poznámka
                        <input type="text" placeholder='Poznámka' onChange={noteValue} />
                    </label>
                    <button className={styles.button} onClick={submitNote}>Přidat víno</button>
                </div>
            </div>
